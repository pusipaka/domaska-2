...
perim_prym=a+a+b+b
plosh_prym=a*b
print(f"перемитр прямоугольника:{perim_prym},площадь прямоугольника{plosh_prym}")
# Задание №2
...
# В результате необходимо получить вещественное число. В нашем примере
a=input()
alg1=int(a[3])**int(a[4])
alg2=alg1*int(a[2])/(int(a[0])-int(a[1]))
print(alg2)